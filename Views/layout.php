...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      <a href="<?= SITEBASE ?>" class="navbar-brand"><img class="logo" src="<?= SITEBASE ?>/img/logo.png" alt="logo"> </a>
  ...
  <footer class="m-5 text-center">sylvain &copy; 2023</footer>
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js"></script>
  <script src="<?= SITEBASE ?>/js/script.js"></script>
